...
class Options(ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument('--make_rows', action='store_true', help='Align the translated plants into rows in output images')
        self.add_argument('--min_rows', type=int, default=1, help='Minimum number of plant rows in output images, selected from [min_rows, max_rows]')
        self.add_argument('--max_rows', type=int, default=3, help='Maximum number of plant rows in output images, selected from [min_rows, max_rows]')
        self.add_argument('--n_per_row', type=int, default=5, help='Number of plants in a row')
        ...
        self.add_argument('--plant_type', type=str, default='All', choices=['All', 'Canola', 'Soybean', 'Oat', 'Wheat'], help='Plant types to use for output images')
